...
define characters = {
    ...
    'eileenu':   CharacterDetails(__('Mad girl'), {'color': '#9a9065'}),
    ...
    'wallaceu':  CharacterDetails(__('Tall guy'), {'color': '#b2678a'}),
...
define character_tags = {
    __('Mad girl'):  'eileen_madgirl',
    __('Tall guy'): 'wallace_tallguy'
}
